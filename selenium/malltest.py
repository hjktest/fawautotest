...
class Faw(unittest.TestCase):
    ...
    def test_faw(self):
        ...
        driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='经销商'])[1]/following::input[1]").send_keys("CC")
        driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='经销商'])[1]/following::div[2]").click()
        driver.find_element_by_xpath(
            u"(.//*[normalize-space(text()) and normalize-space(.)='经销商'])[1]/following::a[1]").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='(6)'])[1]/following::span[1]").click()
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='(7)'])[1]/following::span[1]").click()
